...
class GridsControllerTest < ActionController::TestCase
  ...
  test "should create grid" do
    assert_difference('Grid.count') do
      post :create, grid: { band: @grid.band, call: @grid.call, country: @grid.country, grid_sqare: @grid.grid_sqare, mode: @grid.mode, status: @grid.status }
    end
  ...
  test "should update grid" do
    patch :update, id: @grid, grid: { band: @grid.band, call: @grid.call, country: @grid.country, grid_sqare: @grid.grid_sqare, mode: @grid.mode, status: @grid.status }
    assert_redirected_to grid_path(assigns(:grid))
  end
